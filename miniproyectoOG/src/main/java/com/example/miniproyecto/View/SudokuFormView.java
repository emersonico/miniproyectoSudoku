package com.example.miniproyecto.View;

import com.example.miniproyecto.Controller.SudokuController;
...
public class SudokuFormView extends Stage {
    public SudokuFormView() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/miniproyecto/formsudoku.fxml"));
